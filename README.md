...
You can deploy this exporter by using the  image `kubestar/event-exporter:${VERSION}` in k8s cluster,
the available versions can be got from the [releases](https://github.com/kubestar/event_exporter/releases).
