...
import (
	...
	"github.com/xuyun-io/event_exporter/pkg/utils"
)
...
func TestVersion(t *testing.T) {
	var testcase utils.MetricsTestCases = map[string]utils.MetricsTestCase{
        ...
        event_exporter_build_info{branch="UNKNOWN",build_date="UNKNOWN",build_user="KubeStar Authors",go_version="%s",version="1.0.0"} 1
`, runtime.Version()),
		},
	}
	testcase.Test(t)
